...
- Autonomous Unmanned Ground Vehicle (AUGV)
  - Use case: landing for drone (Holybro, good for testing auto landing system)
  - Mobility
  - Perception
  - Electronics
  - 
...
- UGV for UAV landing (connects with Rocha follow-up) (POC: CAP Silva)
